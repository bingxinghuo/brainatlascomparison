marmoset_mouse_region_compare_app Executable
...
================================
-run_marmoset_mouse_region_compare_app.sh (shell script for temporarily setting 
                                           environment variables and executing the 
                                           application)
   -to run the shell script, type
   
       ./run_marmoset_mouse_region_compare_app.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v912, run the shell script as:
       ...
       ./run_marmoset_mouse_region_compare_app.sh /mathworks/home/application/v912
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_marmoset_mouse_region_compare_app.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure marmoset_mouse_region_compare_app.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r marmoset_mouse_region_compare_app.zip marmoset_mouse_region_compare_app.app
    or the tar command 
    tar -cvf marmoset_mouse_region_compare_app.tar marmoset_mouse_region_compare_app.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v912/runtime/maci64:MR/v912/sys/os/maci64:MR/v912/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_marmoset_mouse_region_compare_app.sh 

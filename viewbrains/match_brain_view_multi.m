%% match_brain_view_multi.m
% Bingxing Huo, Nov 2021
% This script displays multiple regions of interest in mouse and marmoset
% input:
...
function match_brain_view_multi(species,L)
global LUT regions mouselist marmosetlist
%% load atlases
load('atlas_for_vis');
...
for i=1:length(regions)
    region=regions{i};
    primaryidV=primaryidV+ismember(primaryannoatlas,region);
end
